...
from cars.car_form import CarForm
...
#             'form': form,
#         }
#         return render(request, 'add_cr_del_car/car_edit.html', context)
...
#             'car': car,
#         }
#         return render(request, 'add_cr_del_car/car_delete.html', context)
#     else:
#         car.delete()
